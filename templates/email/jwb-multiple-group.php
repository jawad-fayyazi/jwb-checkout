													...
													<td valign="top" style="padding: 48px 48px 32px;">
														<div id="body_content_header" style="color: #494841; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; font-size: 14px; line-height: 150%; text-align: left;">
															<p style="margin: 0 0 16px;">
																<?php printf( 
																	esc_html__( '%1$s invited you to lead a group for %2$s!', 'jwb-checkout' ), 
														...
														<div id="body_content_promo" style="color: #494841; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; font-size: 14px; line-height: 150%; text-align: left; margin-top: 30px; border: 1px solid #e5e5e5;">
															<div style="background-color: #F7F7F7; padding: 15px 20px; border-bottom: 1px solid #e5e5e5;">
																<h3 style="color: #749c90; margin: 0; font-size: 16px; font-weight: bold; text-transform: uppercase;">
																	<?php esc_html_e( 'Your Promo Code', 'jwb-checkout' ); ?>
																</h3>
															</div>
															<div style="padding: 20px; background-color: #ffffff;">
																<p style="margin: 0 0 16px;">
																	<?php esc_html_e( 'Share the 50% off coupon code below with each member of your study group.', 'jwb-checkout' ); ?>
																</p>
																<table style="width: 100%; border-collapse: collapse; margin-top: 15px;">
																	<tr>
																		<td style="padding: 10px 0; font-weight: bold; width: 60%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;">
																			<?php esc_html_e( 'Your 50% off promo code:', 'jwb-checkout' ); ?>
																		</td>
																		<td style="padding: 10px 14px; background-color: #f7f7f7; border: 1px solid #e5e5e5; font-family: monospace; font-size: 16px; letter-spacing: 1px; text-align: center;">
														...
														<div id="body_content_redeem" style="color: #494841; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; font-size: 14px; line-height: 150%; text-align: left; margin-top: 30px;">
															<p style="margin: 0 0 16px;"><?php esc_html_e( 'To access your dashboard and study materials, click the button below and log in.', 'jwb-checkout' ); ?></p>
															<a id="redeem-gift-button" href="<?php echo esc_url( $login_url ); ?>" style="color: #749c90; font-weight: normal; text-decoration: underline; background-color: #749c90; color: #ffffff; display: inline-block; font-size: 14px; font-weight: bold; line-height: 50px; text-align: center; text-decoration: none; width: 250px; -webkit-text-size-adjust: none; text-transform: uppercase; padding-left: 15px; padding-right: 15px; margin-top: 10px;">
																<?php esc_html_e( 'ACCESS YOUR DASHBOARD', 'jwb-checkout' ); ?>
															</a>
														</div>
